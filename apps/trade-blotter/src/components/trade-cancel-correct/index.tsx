    ...
    <>
      <FormContainer>
        <FormRow ref={containerRef}>
          <FormField.Book formik={props.formik} />
          <FormField.TradeTypeUpdate formik={props.formik} disabled />
          <FormField.Client formik={props.formik} />
          {props.formik.values[SF.IS_BANK_LOAN] && <FormField.Security formik={props.formik} />}
        </FormRow>
          ...
          {props.formik.values[SF.IS_PLEDGE_RECEIVE] === false && (
            <>
              ...
              <SfFormikNumericInput
                ...
                formik={props.formik}
                precision={6}
                disabled={isFloatRate.current || isFeeEntered}
                required={!isFeeEntered}
              />
            </>
          )}
